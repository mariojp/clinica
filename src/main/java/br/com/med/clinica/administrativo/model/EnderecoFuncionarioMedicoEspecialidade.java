 ...
 */
public class EnderecoFuncionarioMedicoEspecialidade implements Serializable {
	 ...
	 */
	public EnderecoFuncionarioMedicoEspecialidade() {
	 ...
	 * @param medico_concelho the medico concelho
	 * @param especialidade the especialidade
	 */
	public EnderecoFuncionarioMedicoEspecialidade(Long funcionario_oid, String funcionario_nome, String funcionario_rg,
			...
			String medico_concelho, Especialidade especialidade) {
		super();
	...
	/**
	 * Gets the medico concelho.
	 *
	 * @return the medico concelho
	 */
	...
	/**
	 * Sets the medico concelho.
	 *
	 * @param medico_concelho the new medico concelho
	 */
